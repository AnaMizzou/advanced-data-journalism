...
def get_votes_by_date(chamber, start_date, end_date):
    ...
    # YOUR CODE GOES HERE
    payload= {"chamber":"Senate", "start_date": "2017-03-20", "end_date": "2017-04-10" }
    ...
    data = requests.get(url, headers={"X-API-Key": API_KEY},params=payload).content
    ...
    # Replace this with whatever the data variable should be
